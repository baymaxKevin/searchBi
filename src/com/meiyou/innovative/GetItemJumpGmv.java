...
@Resolve({"string,string->string,bigint,string,string,string,string,string"})
public class GetItemJumpGmv extends UDTF {
    ...
    public void process(Object[] args) throws UDFException {
        ...
        forward(access_time,uid,iid,path,app_id,platform,action);
    }
